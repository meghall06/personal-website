...
Score effects in hockey are well-known, whether you're watching the game or looking at numbers: teams that are losing tend to generate a greater share of the shot attempts. Micah Blake McCurdy developed [an adjustment method](https://www.hockeyviz.com/txt/senstats) for 5v5 events that is currently used to create the score- and venue-adjusted shot attempt metrics available at hockey stats websites like [Natural Stat Trick](http://www.naturalstattrick.com/) and [Evolving Hockey](https://evolving-hockey.com/).
