...
background-image: url(Moneypuck.png)
...
name: moneypuck2
class: inverse, middle, center
background-image: url(Moneypuck2.png)
background-size: contain
...
name: moneypuck4
class: inverse, middle, center
background-image: url(Moneypuck4.png)
background-size: contain
...
name: moneypuck3
class: inverse, middle, center
background-image: url(Moneypuck3.png)
background-size: contain
