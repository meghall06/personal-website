...
Meghan Hall <br> `r icon::fa("twitter")` [@MeghanMHall](https://www.twitter.com) <br> [meghan.rbind.io](https://meghan.rbind.io/) <br> [Hockey (Analytics) Night in Canada](https://www.hanic-analytics.com) <br> Feb. 18, 2021
...
`r icon::fa("twitter")` [@MeghanMHall](https://www.twitter.com) <br> [meghan.rbind.io](https://meghan.rbind.io/) <br>
